...
it('renders google login button', async () => {
  ...
  expect(link.getAttribute('href')).toContain('state=eyJzeXN0ZW1SZWRpcmVjdFVyaSI6Imh0dHBzOi8vc2hvcHMuZXhhbXBsZS1yZXNlbGxlci5jb20iLCJvcmlnaW5hbFN0YXRlIjoiaHR0cHMlM0ElMkYlMkZteS1ncmVhdC1oYW5kaWNyYWZ0LmNvbSJ9');
});
